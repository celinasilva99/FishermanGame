 ...
 * @author cs
 */
public class LevelFour extends GameLevel implements ActionListener{
...
private Fish fish;
    ...
    private Timer timer;
    private Crab c;
      private static final int NUM_FISH = 25;
 ...
 for(int i = 0; i<4;i++){
        ...
        for (int i = 0; i < 4; i++) {
         ...
         c = new Crab(this);
         c.setPosition(new Vec2(d,b));
         c.setGravityScale(2);
         c.setLinearVelocity(new Vec2(3, 2));
